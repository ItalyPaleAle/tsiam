...
func TestNewAzureKeyVaultKeyStorageWithClient(t *testing.T) {
	...
	mockClient := new(MockAzureKeyVaultKeyClient)
	...
	assert.Contains(t, err.Error(), "keyName cannot be empty")
	...
	assert.Contains(t, err.Error(), "storagePath cannot be empty")
}
...
func TestAzureKeyVaultKeyStorage_LoadUnwrapError(t *testing.T) {
	...
	assert.Contains(t, err.Error(), "failed to unwrap key with Azure Key Vault")
...
func TestAzureKeyVaultKeyStorage_StoreWrapError(t *testing.T) {
	...
	assert.Contains(t, err.Error(), "failed to wrap key with Azure Key Vault")
