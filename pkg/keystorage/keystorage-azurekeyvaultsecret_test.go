...
func TestNewAzureKeyVaultSecretStorageWithClient(t *testing.T) {
	mockClient := &MockAzureKeyVaultSecretClient{}
	...
	require.ErrorContains(t, err, "secretName cannot be empty")
}
...
func TestAzureKeyVaultSecretStorage_LoadNonExistent(t *testing.T) {
	...
	require.Nil(t, key, "Expected nil key for non-existent secret")
...
func TestAzureKeyVaultSecretStorage_LoadError(t *testing.T) {
	...
	require.ErrorContains(t, err, "failed to get secret from Azure Key Vault")
...
func TestAzureKeyVaultSecretStorage_StoreError(t *testing.T) {
	...
	require.ErrorContains(t, err, "failed to set secret in Azure Key Vault")
